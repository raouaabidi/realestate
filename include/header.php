<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class="fas fa-phone-alt text-success mr-1"></i> +216 70 660 660</a></li>
                                <li><a href="#"><i class="fas fa-envelope text-success mr-1"></i>RealEstateTunisia@gmail.com</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="main-nav secondary-nav hover-success-nav py-2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><img class="nav-logo" src="images/logo/restate.png" alt=""></a>
