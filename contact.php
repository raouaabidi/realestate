...
<div id="page-wrapper">
    <div class="row"> 
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">Z.I Ksar Said, Avenue de l’indépendance – Tunis</span> <br>
										<span class="text-white"> Z.I CHARGUIA I, Rue de l’industrie – Tunis</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+216 70 660 660</span>
										<span class="text-white">+216 70 660 666 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-white">commercial@realestatest.com</span>
										<span class="text-white">commercial.chaguia@realestatest.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
        ...
        <!--	Map -->
		<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3193.0!2d10.1815!3d36.8065!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12fd337f5e7ef543%3A0xd671924f1f8abe8b!2sTunis!5e0!3m2!1sen!2stn!4v1" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
		<!--	Map -->
